...
//Copied the interrupt.ino example but modified it to
//make it work with softwareWire

#include <SoftwareWire.h>
#include <Adafruit_MCP23017.h>

//Declaring a SoftwareWire object
//2 -> sda
//3 -> scl
SoftwareWire myWire(2, 3);

//Passing object address to the Adafruit_MCP23017
Adafruit_MCP23017 mcp(&myWire);

//Beyond this I have changed nothing for SoftwareWire
